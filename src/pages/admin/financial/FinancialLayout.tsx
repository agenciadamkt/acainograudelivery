...
const navItems = [
    ...
    { label: 'Fluxo de Caixa', path: '/admin/financeiro/fluxo', icon: TrendingUp },
...
export default function FinancialLayout() {
    ...
    return (
        <div className="min-h-screen flex bg-gray-50 dark:bg-[#0F0F14]">
            {/* ─── Desktop Sidebar ─── */}
            <aside className="hidden lg:flex flex-col w-64 bg-white dark:bg-[#16161D] border-r border-gray-200 dark:border-white/[0.06] fixed inset-y-0 left-0 z-30">
                {/* Logo */}
            ...
            {/* ─── Mobile Header ─── */}
            <div className="lg:hidden fixed top-0 left-0 right-0 z-40 bg-white/80 dark:bg-[#16161D]/80 backdrop-blur-xl border-b border-gray-200 dark:border-white/[0.06]">
            ...
            {mobileOpen && (
                <div className="lg:hidden fixed inset-0 z-50 flex">
                    ...
                    <aside className="relative w-72 bg-white dark:bg-[#16161D] flex flex-col shadow-2xl">
            ...
            <main className="flex-1 lg:ml-64">
                {/* Desktop Header */}
                <header className="hidden lg:flex items-center justify-between px-8 h-16 bg-white/60 dark:bg-[#16161D]/60 backdrop-blur-xl border-b border-gray-200 dark:border-white/[0.06] sticky top-0 z-20">
