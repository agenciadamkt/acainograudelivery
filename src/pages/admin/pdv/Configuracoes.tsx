...
import { Printer, Settings, Plug, RefreshCw } from 'lucide-react';
    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center mb-6">
                <div>
                    <h2 className="text-2xl font-bold tracking-tight">Configurações do PDV</h2>
                    <p className="text-muted-foreground">Impressão, Hardware e Integrações.</p>
                </div>
            </div>
