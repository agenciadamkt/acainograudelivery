...
const SEC_ESTOQUE: MenuSection = {
  ...
  items: [
    ...
    { title: 'Grupos de Contagem', url: '/admin/checkgrau/grupos-contagem', icon: ListChecks, requireRole: 'manager', subGroup: 'Controle' },
    { title: 'Contagem Recorrente', url: '/admin/checkgrau/contagens-recorrentes', icon: RotateCcw, requireRole: 'manager', subGroup: 'Controle' },
