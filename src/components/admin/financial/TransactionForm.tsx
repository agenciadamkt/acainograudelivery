...
export function TransactionForm({ onSubmit, onCancel, isSubmitting, defaultType = 'receita' }: TransactionFormProps) {
  ...
  const { data: categories } = useFinancialCategories(transactionType);
