...
export function OrderCard({ order, onViewDetails, onUpdateStatus, onCancelOrder, stopSound }: OrderCardProps) {
  ...
  return (
    <Card className={`p-4 hover:shadow-md transition-shadow ${isPending ? 'animate-pulse-border animate-shake border-4 border-primary bg-primary/5' : ''}`}>
        ...
        <div className="flex items-start justify-between">
          <div>
            <div className="flex items-center gap-2">
              ...
              {isPending && (
                <Badge className="bg-primary text-primary-foreground animate-blink-badge text-lg font-bold px-3 py-1">
                  NOVO!
                </Badge>
              )}
            </div>
          ...
          {order.customer?.phone && (
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="p-2 text-white bg-[#25D366] hover:bg-[#128C7E] rounded-lg transition-all shadow-sm flex items-center justify-center group"
