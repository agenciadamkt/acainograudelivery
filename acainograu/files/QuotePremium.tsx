/**
 * QuotePremium.tsx
 * Componente Premium de Citações com Dot Pattern
 * Integração no GrouOs com design sofisticado
 * 
 * Tecnologias:
 * - React + TypeScript
 * - Tailwind CSS
...
import { Copy, Heart, RotateCw } from 'lucide-react';
  ...
  return (
    <div
      className={cn(
        ...
        variant === 'showcase' && 'border-2 border-slate-300',
        className
      )}
      ...
      >
        ...
        >
          ...
          <span className="inline">
            {variant === 'showcase' ? (
              // Multi-line layout for showcase
...
// ============================================================
// COMPONENTE: QuotePremiumCarousel
// ============================================================

interface QuotePremiumCarouselProps {
  quotes: Quote[];
  accentColor?: string;
  patternDensity?: 'sparse' | 'normal' | 'dense';
  autoplay?: boolean;
...
export function QuotePremiumCarousel({
  quotes,
  accentColor = '#667EEA',
  patternDensity = 'normal',
  autoplay = false,
          ...
          <div className="flex gap-2">
            {quotes.map((_, idx) => (
              <button
                ...
                aria-label={`Ir para citação ${idx + 1}`}
              />
            ))}
          </div>
...
export function QuotePremiumDemo() {
  ...
  const sampleQuotes = [
    ...
    },
    {
      ...
      author: 'Steve Jobs',
      category: 'Inovação',
      source: 'Palestra em Stanford'
    },
    {
      id: 'quote_002',
      text: 'O segredo do sucesso, se é que existe um, é a capacidade de encarar o ponto de vista da outra pessoa.',
  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-6 space-y-8">
      <div>
        <h2 className="text-2xl font-bold mb-4">Variante: Showcase</h2>
        <QuotePremium
          ...
          isFavorited={favorites.includes(sampleQuotes[0].id)}
        />
      </div>

      <div>
        <h2 className="text-2xl font-bold mb-4">Variante: Default</h2>
      ...
      <div>
        <h2 className="text-2xl font-bold mb-4">Carrossel</h2>
